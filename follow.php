...
<body>
    ...
    <div id="friends">
    	  <ul>
    		<li id="follows" style="background-color: #ffffff"><a href="follow.php" ><img src="sources/follow.png" width="20px" height="20px" style="padding-right:5px;vertical-align: top;"/>关注</a></li>
    		<li id="fan"><a href="fan.php" ><img src="sources/fans.png" width="20px" height="20px" style="padding-right:5px;vertical-align: top;"/>粉丝</a></li>
    	</ul>
    </div>
    <div id="lists" style="overflow:auto">
	   ...
	   ?>
	   <div class="fanlist">
    	  <div class="message"><a name="secret"  href="###" title="<?php echo $_rows['id']?>">私信</a></div>
    	  <div class="addfollow"><a href="follow.php?id=<?php echo $_rows['id']?>">取消关注</a></div>
